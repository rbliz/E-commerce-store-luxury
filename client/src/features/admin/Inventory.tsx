...
export default function Inventory() {
    ...
    const [selectedProduct, setSelectedProduct] = useState<Product | undefined>(undefined); // (undefined) because in the ProductForm the product prop is ?undefined
    ...
    // so I am not routing directly to the ProductForm. Instead I am creating state locally in the Inventory
    // if it is in editMode it returns the ProductForm
                            ...
                            >
                                ...
                                <TableCell align="left">
                                    <Box display='flex' alignItems='center'>
                                        <img src={product.pictureUrl} alt={product.name} style={{ height: 50, marginRight: 20, width: '50%' }} />
